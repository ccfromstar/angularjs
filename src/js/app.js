var routerApp = angular.module('routerApp', ['ui.router', 'ngGrid','resApp','expanderModule','applyApp','repeatApp','directiveapp','factoryApp','tanktest','httptest','locationtest', 'BookListModule', 'BookDetailModule']);
/**
